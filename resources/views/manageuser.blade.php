...
<div id="container_manageuser">
    ...
    <a href="/insertadmin" class="inline-block">
    ...
    <table class="min-w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        @foreach($user as $u)
            <tr class="border-b dark:border-gray-700">
                <td class="px-4 py-3">
                    <img src="storage/{{$u->profile_picture}}" alt="Tidak dapat memuat" class="w-20 h-20 object-cover rounded-full border border-gray-300">
                </td>
