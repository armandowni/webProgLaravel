    ...
    <div class="flex justify-center items-center">
        <div class="w-full max-w-lg p-8 space-y-6 bg-white rounded-xl shadow-lg dark:bg-gray-800">
            <div class="flex flex-col items-center">
                <span class="text-3xl font-bold text-blue-700 dark:text-white mb-2">Insert New User</span>
            ...
            @endif
            <form action="insertadmin" method="post" enctype="multipart/form-data" class="space-y-4">
                @csrf
                <div>
                    <label for="fullname"
                ...
                <div>
                    <label for="role"
                        class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-200">Role</label>
